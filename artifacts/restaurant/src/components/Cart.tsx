            ...
            >
              ...
              {items.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center gap-4 p-8 text-center">
                  ...
                  <p className="text-white/40 text-sm">Your cart is empty.<br />Add some delicious meals!</p>
                </div>
              ) : (
                <>
                  ...
                  <div className="p-4 space-y-3" style={{ borderTop: "1px solid rgba(255,255,255,0.07)" }}>
                    ...
                    <div className="space-y-1.5">
                      ...
                      {avgPrepTime > 0 && (
                        <div className="flex items-center gap-1 text-xs pt-1 text-white/30">
                    ...
                    <motion.button
                      ...
                      className="w-full py-4 rounded-2xl font-bold text-white text-sm tracking-wide"
